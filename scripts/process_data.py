...
df = pd.read_csv('/home/illania/project/datasets/data.csv', index_col='timestamp', parse_dates=True)

# Create dataset with hourly segmentation
...
data_p.to_csv('/home/illania/project/datasets/data_processed.csv') 
